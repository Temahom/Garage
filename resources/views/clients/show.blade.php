            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10">
                    ...
                    <div class="text-right" style="font-size: 12px;">
                        ...
                        <button type="button" class="text-danger hide_delete" id="hide_delete" style="border: none; cursor: pointer" data-toggle="modal" data-target="#exampleModal{{ $client->id }}">
                            Supprimer
                        </button>
            ...
            <div class="card">
                ...
                <tr>
                    ...
                    <form action="{{ route('voitures.destroy',$voiture->id) }}" method="POST">   
                            ...
                            @csrf
                            @method('DELETE')      
                            <button type="submit" class="btn btn-danger p-0 pr-2 pl-2 hide_delete" id="hide_delete"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </td>
                </tr>
