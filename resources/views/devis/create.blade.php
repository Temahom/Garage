            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10">
                    ...
                    <div class="text-right" style="font-size: 12px;">
                        ...
                        <button type="button" class="text-danger hide_delete" style="border: none; cursor: pointer" data-toggle="modal" data-target="#exampleModal{{ $voiture->id }}">Supprimer</button>
