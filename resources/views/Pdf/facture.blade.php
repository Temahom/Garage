...
<table style="border-collapse:collapse;border:none;witdh:100%;">
    <tbody>
        ...
        <tr style="height: 30px;text-align:center;">
            ...
            <td style="border:none;">
                <p style="line-height:normal;font-size:15px;font-family:montserrat;text-align:right;">
                    <strong>
                        <span style="font-family:montserrat;color:#333F4F;margin-right: 12px;">COUT DIAGNOSTIC</span>
                    </strong>
                </p>
            </td>
            <td style="width:300px;border:none;border-bottom:solid #BFBFBF 1px;height:33.0px;">
        ...
        <tr style="height: 30px;text-align:center;">
            ...
            <td style="border:none;border-bottom:solid black 1px;background:#eaead3;height:33.0px;">
                <p style="line-height:normal;font-size:13px;font-family:montserrat;text-align:center;">
                    <strong>
                        <span style="font-family:montserrat;">{{ number_format($prix_total+$prixHT+$cout, 0, ',', ' ') }}</span>
                    </strong>
                </p>
