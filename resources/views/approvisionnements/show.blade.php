                        ...
                        <div class="table-responsive">
                            <table id="example4" class="table table-striped table-bordered" style="width:100%">
                                <thead style="background-color: #006680;">
                                    <tr>
                                        <th scope="col" style="color: #ffffff; text-align:center; width: 3%" >N°</th>
                                        ...
                                        <th scope="col" style="color: #ffffff;text-align:center; width: 20%" >Prix d'Achat du Produit</th>
                                ...
                                <tbody>
                                    ...
                                    @endforeach
                                        <tr>
                                            <td colspan="4" style="text-align: end;">Montant Total de l'Approvisionnement   </td>
                                        @php
                                            $prix_tt= 0;
