...
<<<<<<< HEAD
            ...
            <div class="pull-right">
                <a class="btn btn-danger" href="{{ route('approvisionnements.create') }}" title="Create a project"> <i class="fas fa-plus-circle"> Ajouter</i>
                    </a>
=======
                <h2>
                    <span class="titre"><i class="fas fa-list-ul label"></i>Liste approvisionnements</span>
                </h2>
>>>>>>> a496209f8bb9b3cdfad5477a579edf99be658c9d
            </div>
        </div>
    </div>
</div>
                            ...
                            <table id="example4" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr style="background-color: #006680;">
                                        <th style="color: white; text-align:center; width: 5%">N°</th>
                                        <th style="color: white; text-align:center;">Fournisseur</th>
                                        <th style="color: white; text-align:center;">Date Approvisionnement</th>
                                        <th style="color: white; text-align:center;">Nombre D'articles</th>
                                        <th style="color: white; text-align:center;">Coût Facture</th>
                                ...
                                <tbody>
                                    @foreach ($approvisionnements as $approvisionnement)
                                        <tr>
                                            <td onclick="showAppro({{ $approvisionnement->id }})" style="cursor: pointer; text-transform: capitalize; text-align:center;">{{ $approvisionnement->id }}</td>
                                            <td onclick="showAppro({{ $approvisionnement->id }})" style="cursor: pointer; text-transform: capitalize; text-align:center;">{{ $approvisionnement->fournisseur()->first()->prenom }} {{ $approvisionnement->fournisseur()->first()->nom }}</td>
                                            ...
                                            @php
                                                ...
                                                $prix_tt;
                                            @endphp
                                            <td style="cursor: pointer; text-transform: capitalize; text-align:center;">{{$prix_tt}} <sup>FCFA</sup> </td>
