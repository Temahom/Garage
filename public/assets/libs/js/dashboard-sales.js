    ...
    var total_passer=0;
        $.ajax({
            ...
            success: function (data) {
                //data[0]
                data.semaine_passer.map((s)=>{
                    passer.push(s.montant)
                    total_passer+=s.montant
                })
                data.cette_semmaine.map((s)=>{
                    present.push(s.montant)
                    total_present+=s.montant
                    ///console.log(present.reverse());
                })
                $("#present").html(int1.format(total_present) + " <sup>F CFA</sup>");
                $("#passer").html(int1.format(total_passer) + " <sup>F CFA</sup>");
